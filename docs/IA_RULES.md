...
### Implementación
- [ ] Código implementado según especificaciones del TASK_BREAKDOWN.md
- [ ] Arquitectura Clean respetada (capas correctas)
- [ ] Convenciones de naming seguidas (snake_case archivos, PascalCase clases)
- [ ] Documentación DartDoc completa en clases/métodos públicos
...
- [ ] Commits atómicos (1 cambio lógico por commit)
...
### Documentación
- [ ] TASK_BREAKDOWN.md actualizado (estado → ✅ Completada)
...
- Tarea <id+1>: <nombre>
- Mergear feature branch a develop (si aún no se hizo)
```
